    ...
    fun signUp(){
        ...
        database.collection(Constant.KEY_COLLECTION_USERS).add(user)
            .addOnSuccessListener {
                ...
                LocalDataManager.instance.putString(this@SignUpActivity, Constant.KEY_FIRST_NAME, binding.firstName.text.trim().toString())
                LocalDataManager.instance.putString(this@SignUpActivity, Constant.KEY_LAST_NAME, binding.lastName.text.trim().toString())
                LocalDataManager.instance.putString(this@SignUpActivity, Constant.KEY_EMAIL, binding.email.text.trim().toString())
                LocalDataManager.instance.putString(this@SignUpActivity, Constant.KEY_PASSWORD, binding.password.text.trim().toString())
                LocalDataManager.instance.putBoolean(this@SignUpActivity, Constant.KEY_IS_SIGNED_IN,true)
